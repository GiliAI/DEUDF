...
def generate_model(file_dir,file_name,assign_materials=True):
    ...
    ptColor = bt.colorObj((179.0/255, 190.0/255, 203.0/255, 1), 0.5, 1.3, 1.0, 0.0, 0.0)
    ptSize = 0.005
    bt.setMat_pointCloud(ob, ptColor, ptSize)
...
if __name__ == "__main__":
    in_floder = "D:\\render_data\\all_data_for_render\\open_model_gt\\"
    ...
    for obj_name in os.listdir(in_floder):
        ...
        light_obj.location = (0.05, 0.07, 0.25)
        ...
        lookAtPos = (0, 0, 0.3)  # look at position
