...
if __name__ == "__main__":
    ...
    for obj_name in os.listdir(in_floder):
        ...
        light_obj.location=(0 ,-16.5572,15.7817 )
        ...
        # bt.invisibleGround(location=(0,0,-0.25),shadowBrightness=0.9)
        ## set ambient light
        ...
        H = 0.5  # height of the circle camera path
        lookAtPos = (0, 0, 0.0)  # look at position
