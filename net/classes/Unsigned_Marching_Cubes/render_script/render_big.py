...
def generate_model(file_dir,file_name,assign_materials=True):
    ...
    ob.location=(-0.0      ,-0.0      ,-ob.bound_box[0][2]       )
    ...
    # bt.setMat_transparent(ob, bt.colorObj((179.0 / 255, 190.0 / 255, 203.0 / 255, 1), 0.5, 1.5, 1.0, 0.0, 0.0),0.5,0.1)
...
if __name__ == "__main__":
    in_floder = "D:\\render_data\\all_data_for_render\\big\\"
    ...
    for obj_name in os.listdir(in_floder):
        ...
        ## set ambient light
        bt.setLight_ambient(color=(0.1, 0.1, 0.1, 1.1))
