...
import bpy
import sys
sys.path.append('/home/chenxh/BlenderToolbox') # change this to your path to “path/to/BlenderToolbox/
...
if __name__ == "__main__":
    in_floder = "/pub/data/chenxh/cloth/mesh_cloth/"
    with open("/home/chenxh/CAP-UDF-master/batch_file/cloth_sub_2-3.json", "r") as f:
        paths = json.load(f)
    for object in paths:
        ...
        folder = "/pub/data/chenxh/cloth_film/{}".format(obj_name)
