...
def generate_model(file_dir,file_name,offset):
    ...
    ob.location = (offset[0], offset[1], -ob.bound_box[0][1]*0.5)
...
if __name__ == "__main__":
    in_floder = "D:\\render_data\\all_data_for_render\\high\\"
    reset_scene()
    ...
    for i, path in enumerate(os.listdir(in_floder)):
    ...
    while movie_duration<total_movie_duration:
        ...
        filename = obj_name +"_" + str(frame).zfill(3) + "_" + in_floder.split("\\")[-2]+ '.png'
