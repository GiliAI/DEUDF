...
def generate_model(file_dir,file_name,assign_materials=True):
    ...
    alpha = 0.1
    transmission = 0.5
    meshColor = bt.colorObj((179.0 / 255, 190.0 / 255, 203.0 / 255, 1))
    AOStrength = 0.0
    bt.setMat_singleColor(ob, meshColor, AOStrength)
...
if __name__ == "__main__":
    in_floder = "D:\\render_data\\all_data_for_render\\non_manifold\\"
    ...
    for obj_name in os.listdir(in_floder):
        ...
        ## set light
        lightAngle = (71.9812, -27.2594, -122)
        strength = 3
        shadowSoftness = 0.3
