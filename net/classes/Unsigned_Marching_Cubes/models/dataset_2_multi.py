...
def process_data(data_dir, dataname, sample=100000):
    ...
    return mesh, centers,total_size,mesh.bounds
...
class Dataset:
    def __init__(self, conf, dataname):
        ...
        self.mesh, self.centers, self.total_size,self.bounds = process_data(self.data_dir, dataname)
