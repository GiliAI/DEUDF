...
# from classes.DCUDF
# from net.classes.DCUDF.dcudf.VectorAdam import VectorAdam
...
class dcudf:
    ...
    def optimize(self):
        ...
        # self.mesh = trimesh.load("./stonewall.ply")

        dc_mesh = self.mesh
                
        # advanced return
        # return dc_mesh,dc_mesh,dc_mesh
        ...
        another_final_mesh = trimesh.Trimesh(vertices=xyz.detach().cpu().numpy(), faces=self.mesh.faces, process=False)
        ...
        if self.is_cut == 1:
            ...
            if final_mesh_cuple is not None:
                ...
                if len(final_mesh_1.vertices)>len(final_mesh_2.vertices):
                    ...
                    # another_final_mesh = final_mesh_2
                else:
                    final_mesh = final_mesh_2
                    # another_final_mesh = final_mesh_1
            else:
        ...
        return dc_mesh,final_mesh ,another_final_mesh
